...
LCM_DRIVER *lcm_driver_list[] = {
	...
	&lcm_common_drv,
#else
#if defined(NT51021_FHD_DSI_VDO_INNOLUX)
	&nt51021_fhd_dsi_vdo_innolux_lcm_drv,
#endif
#if defined(NT51021_FHD_DSI_VDO_AUO)
	&nt51021_fhd_dsi_vdo_auo_lcm_drv,
#endif
#if defined(NT51021_FHD_DSI_VDO_BOE)
	&nt51021_fhd_dsi_vdo_boe_lcm_drv,
#endif
#if defined(NT51021_FHD_DSI_VDO_TIANMA)
        &nt51021_fhd_dsi_vdo_tianma_lcm_drv,
#endif
