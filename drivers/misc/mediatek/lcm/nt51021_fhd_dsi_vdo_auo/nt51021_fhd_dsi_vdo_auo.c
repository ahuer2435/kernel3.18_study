...
static void init_lcm_registers(void)
{
	...
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x808C1500;
	dsi_set_cmdq(data_array, 1, 1);
	
	//register C0 to CF
	data_array[0]=0x01C01500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0xA0C11500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x40C21500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x0CC31500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x01C41500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x21C51500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x29C61500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x49C71500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0xF0C81500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x00C91500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x18CA1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x0CCB1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x01CC1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x7CCD1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0xC0CE1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x44D11500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x01D21500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x44D31500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x18D41500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x0CD51500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x01D61500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x04D71500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x00D81500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x09D91500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x03DA1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x61DB1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x02DC1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x02DD1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x02DE1500;
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0]=0x00DF1500;
	dsi_set_cmdq(data_array, 1, 1);
