...
static struct i2c_board_info __initdata i2c_kxtj2_1009={ I2C_BOARD_INFO(KXTJ2_1009_DEV_NAME, KXTJ2_1009_I2C_SLAVE_ADDR)};
...
static struct acc_hw* get_kxtj2_1009_cust_acc_hw(void);
...
static int kxtj2_1009_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	GSE_LOG("%s: OK\n", __func__);
  	kxtj2_init_flag = 0;    
	hardware_info.gsenor_name = kxtj2_1009_name;
