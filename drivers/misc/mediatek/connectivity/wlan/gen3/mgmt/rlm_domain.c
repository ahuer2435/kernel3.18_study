...
static const UINT_16     g_u2CountryGroup1[] =
{
    ...
    COUNTRY_CODE_US,    COUNTRY_CODE_VI,    COUNTRY_CODE_CO

};
/* HQ00904544,chengwei,20140106,modify the wifi 802.11ac chanels,begin */
static const UINT_16     g_u2CountryGroup2[] = {
    COUNTRY_CODE_AZ,    COUNTRY_CODE_BW,
    COUNTRY_CODE_KH,    COUNTRY_CODE_CX,    COUNTRY_CODE_CR,
    ...
    COUNTRY_CODE_AN,    COUNTRY_CODE_NI,    COUNTRY_CODE_PW,
...
/* HQ00904544,chengwei,20140106,modify the wifi 802.11ac chanels,end */
...
static const UINT_16     g_u2CountryGroup5[] =
{
    ...
    COUNTRY_CODE_IQ,    COUNTRY_CODE_IE,    COUNTRY_CODE_IT,    
...
static const UINT_16     g_u2CountryGroup11[] = {COUNTRY_CODE_PG};
...
static const UINT_16     g_u2CountryGroup16[] =
{
    ...
    COUNTRY_CODE_FK,    COUNTRY_CODE_KZ,    COUNTRY_CODE_MZ,
    COUNTRY_CODE_LC,    COUNTRY_CODE_VC,
    COUNTRY_CODE_UZ,    COUNTRY_CODE_ZW
};
static const UINT_16     g_u2CountryGroup17[] = {COUNTRY_CODE_MP,    COUNTRY_CODE_MX};
...
static const UINT_16     g_u2CountryGroup27[] =
{
    COUNTRY_CODE_DF
...
{
    COUNTRY_CODE_UG,    COUNTRY_CODE_TZ,    COUNTRY_CODE_NA
};
...
static const UINT_16     g_u2CountryGroup26[] =
{
    COUNTRY_CODE_UA
};
/* HQ00904544,chengwei,20140106,modify the wifi 802.11ac chanels,end */
...
DOMAIN_INFO_ENTRY arSupportedRegDomains[] = {
    ...
    },
    {
        (PUINT_16) g_u2CountryGroup15, sizeof(g_u2CountryGroup15) / 2,
        {
            ...
            { 118, BAND_5G,  CHNL_SPAN_20,  52,   4,  TRUE }, /* CH_SET_UNII_MID_52_64 */
            { 121, BAND_NULL,           0,   0,   0,  FALSE }, /* CH_SET_UNII_WW_100_140 */
            { 125, BAND_5G,  CHNL_SPAN_20, 149,   5,  FALSE }, /* CH_SET_UNII_UPPER_149_165 */
            {   0, BAND_NULL,           0,   0,   0,  FALSE }
        }
    },
	...
	{
        (PUINT_16) g_u2CountryGroup26, sizeof(g_u2CountryGroup26) / 2,
        {
            {  81, BAND_2G4, CHNL_SPAN_5,    1,  13,  FALSE }, /* CH_SET_2G4_1_13 */
    ...
    },
	{
        ...
        (PUINT_16) g_u2CountryGroup27, sizeof(g_u2CountryGroup27) / 2,
        {
            {  81, BAND_2G4, CHNL_SPAN_5,    1,  13,  FALSE }, /* CH_SET_2G4_1_13 */
            ...
            { 118, BAND_5G,  CHNL_SPAN_20,  52,   4,  TRUE }, /* CH_SET_UNII_MID_52_64 */
            { 121, BAND_5G,  CHNL_SPAN_20, 100,  12,  TRUE }, /* CH_SET_UNII_WW_100_144 */
            { 125, BAND_5G,  CHNL_SPAN_20, 149,   5,  FALSE }, /* CH_SET_UNII_UPPER_149_173 */
            {   0, BAND_NULL,           0,   0,   0,  FALSE }
        }
    }
};
...
{
#define REG_DOMAIN_DEF_IDX          27	/* EU (Europe Union) */
